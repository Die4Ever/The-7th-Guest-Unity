unit AviWriter;
(* 2005-10-01: Adapted to 24-bit videos for VDXExt, Deniz Oezmen
 *             No guarantee for this ...
 * 2005-10-03: Added more precision for dwRate/dwScale, Deniz Oezmen
 *)
       ...
       try
          ...
          for i := 0 to Bitmaps.count - 1 do begin
             try
               ...
               InternalGetDIB
                     (Bitmap.Handle, 0, BitmapInfo^, BitmapBits^, pf24bit);
